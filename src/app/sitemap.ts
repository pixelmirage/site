...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const staticRoutes: Record<string, { lastModified: string; priority: number }> = {
        ...
        '/izmir-bosanma-avukati': { lastModified: '2026-04-18', priority: 1 },
        ...
        '/kira-sozlesmesi-ornegi': { lastModified: '2026-04-17', priority: 0.8 },
        ...
        '/izmir-bosanma-avukati/anlasmali-bosanma': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/velayet-davasi': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/nafaka-davasi': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/cekismeli-bosanma-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/bosanma-sureci-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/bosanma-avukati-ucretleri-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/mal-paylasimi-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/aldatma-bosanma-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/aile-hukuku-avukati-izmir': { lastModified: '2026-04-18', priority: 0.9 },
        '/izmir-bosanma-avukati/bosanma-davasi-nasil-acilir-izmir': { lastModified: '2026-04-18', priority: 0.9 },
