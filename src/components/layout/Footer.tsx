            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-12 border-t border-border/50">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <a href="https://www.izmirbarosu.org.tr" target="_blank" rel="noopener noreferrer" className="text-[10px] text-muted-foreground uppercase tracking-widest hover:text-primary transition-colors">İzmir Barosu</a>
                    </div>
                </div>
            </div>
        </footer>
